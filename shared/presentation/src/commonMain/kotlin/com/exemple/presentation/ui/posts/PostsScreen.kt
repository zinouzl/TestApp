package com.exemple.presentation.ui.posts
...
import testapp.shared.presentation.generated.resources.ic_arrow_back
import testapp.shared.presentation.generated.resources.post_title
import testapp.shared.presentation.generated.resources.user_name
        ...
        topBar = {
            Surface(
                ...
                Row(
                    ...
                    Text(text = stringResource(resource = Res.string.post_title))
                }
            }
        }
    ) {
        ...
        stickyHeader {
            Box(
                ...
                Row(
                    ...
                    Text(text = stringResource(resource = Res.string.user_name))
